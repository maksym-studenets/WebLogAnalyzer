...
public class Functions {
    ...
    public static final Function2<List<Long>, Optional<Long>, Optional<Long>>
            computeRunningSum = (nums, current) -> {
    ...
    @Nullable
    public static final Tuple4<Long, Long, Long, Long> computeContentSizeStats(
    ...
    public static final JavaRDD<String> filterIpAddresses(
